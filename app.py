...
def start(update, context):
    ...
    context.bot.send_message(chat_id=update.effective_chat.id, text="To join message for details.")
    context.bot.send_message(chat_id=update.effective_chat.id, text="This bot is to help you forward messages.")
    # Set the bot's description
    context.bot.set_my_commands([BotCommand("start", "Request for more details.")])
    context.bot.set_description("This bot is to help you forward messages.")  # Add your bot description here
